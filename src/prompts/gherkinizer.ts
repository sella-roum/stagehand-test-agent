...
3.  **データテーブルの抽出**: フォーム入力のようなキーと値のペアのデータは、必ず'table'プロパティとして抽出してください。
4.  **完全性の保証**: **絶対にユーザーの指示の一部を省略してはいけません。** 入力されたシナリオの意図をすべてJSONのステップに変換してください。
5.  **出力形式**: 最終的な出力は、指定されたJSONスキーマに厳密に従った単一のJSONオブジェクトでなければなりません。説明やMarkdownは含めないでください。
  ...
  "scenarios": [
    {
      ...
      "steps": [
        ...
        { "keyword": "And", "text": "ログインボタンをクリックする" },
        { "keyword": "Then", "text": "ユーザーは「マイページ」にリダイレクトされる" },
        { "keyword": "And", "text": "画面に「ようこそ、hanakoさん」と表示されている" },
        ...
        { "keyword": "And", "text": "「注文を確定する」ボタンをクリックする" },
